...
import { getAiResponse, uploadFile } from "@/lib/prompts";
...
export default function ChatInterface() {
  ...
  const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Check file type (optional - allow common document types)
    const allowedTypes = [
      'application/pdf',
      // 'application/msword',
    ...
    if (!allowedTypes.includes(file.type)) {
      setUploadMessage({ type: 'error', text: 'Invalid file type. Please upload PDF files.' });
